...
function Thread() {
  return (
    <div className='mt-20 w-5/6 mx-auto sm:mt-32 max-w-42rem'>
      ...
      <div className='mt-8 w-fit mx-auto sm:mt-12'>
        <p className='ml-4'>ID: <span className='text-secondaryTextColor font-RegularFont font-normal'>0x9k3jrwo3</span></p>
        <div className='w-full bg-secondaryBackgroundDarkColor rounded-2xl border-2 border-solid border-borderColor mt-2 p-6 semiNormal:grid semiNormal:grid-cols-3 semiNormal:gap-6 sm:grid-cols-4 sm:gap-6 max-w-42rem'>
          <div className='mt-2 mb-6 sm:mb-0 sm:mt-0 sm:flex sm:flex-col sm:items-start sm:justify-center semiNormal:col-span-3 sm:col-span-4'>
            <img className='w-full h-full object-cover rounded-lg' src="https://images.unsplash.com/photo-1528164344705-47542687000d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1492&q=80" alt="thread image source" />
          </div>
          ...
          <div className='mt-6 semiNormal:mt-0 semiNormal:flex semiNormal:flex-col semiNormal:items-start semiNormal:justify-center semiNormal:col-span-3 sm:col-span-4'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate magnam delectus non, minima, temporibus blanditiis, corrupti vero magni quisquam eligendi nobis sapiente quibusdam sed vitae earum sint possimus nemo adipisci.</p>
          </div>
        </div>
      </div>
      <button></button>
